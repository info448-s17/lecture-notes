...
![Lifecycle state diagram, from Google. See also an alternative, simplified diagram [here](http://developer.android.com/images/training/basics/basic-lifecycle.png).^[http://developer.android.com/images/activity_lifecycle.png]](img/activities/activity_lifecycle.png)
