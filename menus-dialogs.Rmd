# UI Components
This lecture discusses how to include **menus** and **pop-up dialogs** in an Android application as additional navigation and display components. Note that this lecture aims to provide _exposure_ rather than _depth_ to these concepts; for further details and options, see [the official Android documentation]().
